...
#SBATCH --output=/home/s.amir/projects/MIMIC_embeddings/DATA/slurm_logs/build_U2V_cpu_out_%j.txt
#SBATCH --error=/home/s.amir/projects/MIMIC_embeddings/DATA/slurm_logs/build_U2V_cpu_err_%j.txt
#SBATCH --mem 60G
